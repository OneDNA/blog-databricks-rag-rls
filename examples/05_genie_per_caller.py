...
def main() -> int:
    ...
    print("  It is prompt scoping -- model reluctance to name a table it has not been shown --")
    print("  and it changes with a model update and no release note. The vendor documents the")
    print("  opposite guarantee.")
    print()
