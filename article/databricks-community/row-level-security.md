...
enforcement on the platform side of the boundary this post has been drawing. It does not escape the
same class of mistake — our `sensitivity` filter once named a column no stage produced, and on
pgvector that is a hard "column does not exist" rather than a silent pass. Equally broken, but you
find out.
